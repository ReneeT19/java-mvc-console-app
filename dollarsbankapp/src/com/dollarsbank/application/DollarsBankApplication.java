...
public class DollarsBankApplication {
    ...
    public static void runCreateAccountCommand(Scanner scan) {
        ...
        Customer newCustomer = new Customer(-1, customerName, customerAddress, customerNumber, password, initialDeposit, accountId);
    ...
    public static void runLogInCommand(Scanner scan) throws InterruptedException {
        ...
        while (checking) {
            ...
            if (userId == 100 && userPassword.equals("ABCabc100!")) {
...
//                          break;
    ...
    //deposit method
    public static void depositAmount() throws InterruptedException
    {
        Scanner scan = new Scanner(System.in);
        long depositAmt;
